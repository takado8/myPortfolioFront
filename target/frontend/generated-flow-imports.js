...
addCssBlock(`<custom-style><style include="noPaddingOrMargin">${$css_2}</style></custom-style>`);
import $css_3 from 'Frontend/styles.css';
addCssBlock(`<custom-style><style include="labelTradesStyle">${$css_3}</style></custom-style>`);
